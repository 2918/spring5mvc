...
<div class="container">
  <form class="form-horizontal" action="updateCustomer" method="post" name="updateCustomerForm">
    <div class="row">
...
<div class="form-group"> 
    <div class="col-sm-offset-2 col-sm-10" style="align:center">
      <button type="submit" id="customerUpdate" class="btn btn-default">Update</button>
